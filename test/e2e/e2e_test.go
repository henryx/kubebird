...
const namespace = "kubebird-system"

// serviceAccountName created for the project
const serviceAccountName = "kubebird-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "kubebird-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "kubebird-metrics-binding"
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=kubebird-metrics-reader",
		...
		// instanceLifecycleSpecs (test/e2e/instance_test.go) exercises the
		// Instance CRD end to end: cross-field validation, deployment of
		// the Secret/ConfigMap/Service/StatefulSet, real database
		// provisioning inside the Firebird container, adding a database
		...
		// fbsvcmgr's remote nbackup action and gzips the result
		// (spec.backup.compress), a second run lands next
